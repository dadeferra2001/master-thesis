...
from traffic_rl.algo_shared import train
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train parameter-sharing PPO.")
    parser.add_argument("--env-config", default="configs/env.yaml")
    parser.add_argument("--ppo-common", default="configs/ppo_common.yaml")
    parser.add_argument("--ppo-config", default="configs/ppo_shared.yaml")
