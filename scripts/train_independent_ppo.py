...
from traffic_rl.algo_independent import train
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train independent PPO agents.")
    parser.add_argument("--env-config", default="configs/env.yaml")
    parser.add_argument("--ppo-common", default="configs/ppo_common.yaml")
    parser.add_argument("--ppo-config", default="configs/ppo_independent.yaml")
